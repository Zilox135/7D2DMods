...
public class BlockPickupLoot : BlockLoot
{
	...
	private string PickupSound = "NoSound";
	...
	public override void Init()
	{
		...
		if (this.Properties.Values.ContainsKey(BlockPickupLoot.PropPickupSound))
		{
			this.PickupSound = this.Properties.Values[BlockPickupLoot.PropPickupSound];
		}
	}
